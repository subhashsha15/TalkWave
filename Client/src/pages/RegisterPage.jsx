        ...
        <div className='bg-white w-full max-w-md  rounded overflow-hidden p-4 mx-auto'>
          ...
          <form className='grid gap-4 mt-5' onSubmit={handleSubmit}>
            ...
            <div className='flex gap-5'>
              <label htmlFor='profile_pic' className='flex justify-start'>Photo :

                <div className='h-auto bg-slate-200 flex justify-center items-center border rounded hover:border-primary cursor-pointer'>
