...
const MessagePage = () => {
  ...
  useEffect(() => {
    console.log("message page user id before connection",params.userId)
    if (socketConnection) {
      socketConnection.emit('message-page', params.userId)
      console.log("message page user id after connection",params.userId)
    ...
    <div style={{ backgroundImage: `url(${backgroundImage})` }} className='bg-no-repeat bg-cover'>
      <header className='sticky top-0 h-16 bg-white flex justify-between items-center px-4'>
        ...
        <div className='flex justify-center gap-2'>
          <button className='cursor-pointer  hover:bg-gray-200 hover:rounded-full'>
            <img src="/Search-icon.svg" alt="" />
          </button>
          <button className='cursor-pointer hover:bg-gray-200 hover:rounded-full'>
            <img src="/Call-icon.svg" alt="" />
          </button>
